...
class SixthQSerializer(ModelSerializer):
    cantidad_ies = serializers.IntegerField()
    class Meta:
        model = Info
        fields = ['anio','metodologia','cantidad_ies']
...
class TenthQSerializer(ModelSerializer):
    class Meta:
        model = Info
        fields = ['ies','programa_academico','metodologia','sector_ies','nivel_academico']
